 ...
 *
 * Clickable: routes to /void-field/boss-encounter while visible, passing
 * the current href as the return target.
 */
  ...
  function handleEngage() {
    const returnHref =
      typeof window !== "undefined"
        ...
        : "/deploy-into-void/field";
    router.push(
      `/void-field/boss-encounter?return=${encodeURIComponent(returnHref)}`,
    );
  }
  ...
  return (
    ...
    >
      <button
        ...
        className="pointer-events-auto rounded-xl border border-red-400/60 bg-red-950/80 px-6 py-4 shadow-[0_0_60px_rgba(239,68,68,0.4),0_0_120px_rgba(153,27,27,0.25)] backdrop-blur-sm transition hover:border-red-200/80 hover:bg-red-900/90"
      >
        <div className="text-[10px] font-bold uppercase tracking-[0.3em] text-red-300/90">
          Boss Incoming — Tap to Engage
        </div>
