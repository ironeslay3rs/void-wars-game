...
// Keep the main background scene distinct even while it temporarily reuses the city art asset.

export default function MainBackgroundScene() {
  return (
    <SceneBackdrop
      sceneId="main-background-scene"
      layers={
        <>
