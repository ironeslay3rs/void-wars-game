  ...
  return (
    <header className="absolute inset-x-0 top-0 z-30 px-4 pt-3 sm:px-6">
      <div className="relative mx-auto max-w-[1700px]">
        <div className="flex items-center justify-between rounded-[18px] border border-white/10 bg-black/30 px-3 py-2 shadow-[0_14px_36px_rgba(0,0,0,0.28)] backdrop-blur-md xl:hidden">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-[15px] font-black uppercase tracking-[0.14em] text-slate-100">
                {homeSceneData.title}
              </div>
              <p className="text-[9px] font-black uppercase tracking-[0.42em] text-slate-300/85">
        ...
        <div className="relative mx-auto hidden h-24 items-start justify-between xl:flex">
