...
export default function TopBar() {
  return (
    <header className="safe-area-top safe-area-x absolute inset-x-0 top-0 z-30">
      <div className="relative mx-auto flex h-24 max-w-[1700px] items-start justify-between">
        ...
        <div className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2">
          <div className="relative min-w-[320px] px-6 pt-1 text-center sm:min-w-[560px] sm:px-16">
            ...
            <h1 className="text-[30px] font-black uppercase leading-none tracking-[0.12em] text-slate-100 drop-shadow-[0_8px_22px_rgba(0,0,0,0.4)] sm:text-[54px]">
              {homeSceneData.title}
            </h1>

            <p className="mt-1 text-xs font-black uppercase tracking-[0.28em] text-slate-300 sm:text-[11px] sm:tracking-[0.7em]">
