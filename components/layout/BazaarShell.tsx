  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      <Image
        ...
        alt="Market city map background"
        fill
        priority
      ...
      <div className="absolute inset-0 z-10 bg-[radial-gradient(circle_at_center,rgba(255,160,60,0.14),transparent_30%),linear-gradient(to_bottom,rgba(2,4,10,0.45),rgba(2,4,10,0.86)),linear-gradient(to_right,rgba(0,0,0,0.52),transparent_20%,transparent_80%,rgba(0,0,0,0.52))] opacity-95" />
