...
export default function CraftingDistrictPage() {
  ...
  function craftMossRation() {
    if (!canCraftMossRation) {
      setRationResult("Need 2 Bio Samples and 1 Rune Dust to bind 1 Moss Ration.");
      return;
    }
          ...
          <div className="grid gap-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/25 p-6">
              ...
              <div className="mt-4 rounded-xl border border-emerald-400/20 bg-emerald-500/8 p-4">
                ...
                <div className="mt-2 text-sm text-white/65">
                  Immediate survival function: bind 2 Bio Samples and 1 Rune Dust into 1 Moss Ration.
                </div>
                ...
                >
                  Craft Moss Ration
                  <div className="mt-1 text-xs text-white/60">
                    Costs 2 Bio Samples + 1 Rune Dust / Produces 1 Moss Ration
                  </div>
                </button>

                <div className="mt-3 rounded-xl border border-white/10 bg-black/20 px-4 py-3 text-sm text-white/75">
                  {rationResult ?? "Binder idle. Stock rations before long operations strain condition."}
                </div>
              </div>
            </div>
          </div>
